...
<body class="custom_cursor">
        ...
        <div id="black workcont" class="wblack">
            <section id="container__work--black">
                <div id="project-text">
                    ...
                    <p>Since 2012 I’ve had privileges and opportunities to design for entrepreneurs, startups, and for SaaS companies with a global reach. By using insights, design frameworks and design principles I'm able to rapidly deliver an <span id="wstrong">impactful outcome</span>, not only pixels. My mission is simple — <span id="wstrong">design the best solutions</span> and for that I willing to go extra mile. See some of the choosen case  studies <span id="warrow">↘</span>
                    </p>
                </div>
    ...
    <section id="designsources">
        <div class="about--wrapper">
            <div class="figma--deco">Free sources</div>
